...
__export(acvm_js_exports, {
  Trap: () => Trap,
  WasmBlackBoxFunctionSolver: () => WasmBlackBoxFunctionSolver,
  and: () => and,
  blake2s256: () => blake2s256,
  buildInfo: () => buildInfo,
  compressWitness: () => compressWitness,
  createBlackBoxSolver: () => createBlackBoxSolver,
  ...
  executeCircuitWithBlackBoxSolver: () => executeCircuitWithBlackBoxSolver,
...
function executeCircuitWithBlackBoxSolver(solver, circuit, initial_witness, foreign_call_handler) {
...
function executeCircuit(circuit, initial_witness, foreign_call_handler) {
  const ptr0 = passArray8ToWasm0(circuit, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
  const ret = wasm.executeCircuit(ptr0, len0, addHeapObject(initial_witness), addHeapObject(foreign_call_handler));
  return takeObject(ret);
}
function createBlackBoxSolver() {
...
function getPublicWitness(circuit, solved_witness) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passArray8ToWasm0(circuit, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
function getPublicParametersWitness(circuit, solved_witness) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passArray8ToWasm0(circuit, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
function getReturnWitness(circuit, witness_map) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passArray8ToWasm0(circuit, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
var WasmBlackBoxFunctionSolver = class _WasmBlackBoxFunctionSolver {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_WasmBlackBoxFunctionSolver.prototype);
    obj.__wbg_ptr = ptr;
    return obj;
  }
  __destroy_into_raw() {
...
function __wbg_get_imports() {
  ...
  imports.wbg.__wbg_new_e40873b83efb2dcd = function() {
...
function abiEncode(abi, inputs, return_value) {
  try {
    ...
    wasm2.abiEncode(retptr, addHeapObject2(abi), addHeapObject2(inputs), addHeapObject2(return_value));
...
function __wbg_adapter_28(arg0, arg1, arg2, arg3) {
  wasm2.wasm_bindgen__convert__closures__invoke2_mut__h640c0c6add9d0132(arg0, arg1, addHeapObject2(arg2), addHeapObject2(arg3));
}
